...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        for (var i=0; i<scripts.length; i++) {
            if (scripts[i].src.match(/DateTimeShortcuts/)) {
                ...
                DateTimeShortcuts.admin_media_prefix = '/admin_media/'; //scripts[i].src.substring(0, idx); -- Marinho Brandao
                break;
            }
        }
    ...
    handleCalendarCallback: function(num) {
        ...
        return "function(y, m, d) { DateTimeShortcuts.calendarInputs["+num+"].value = (d<10?'0':'')+d+'/'+(m<10?'0':'')+m+'/'+y; document.getElementById(DateTimeShortcuts.calendarDivName1+"+num+").style.display='none';}"; // -- Marinho Brandao
    },
    handleCalendarQuickLink: function(num, offset) {
       var d = new Date();
       d.setDate(d.getDate() + offset)
       DateTimeShortcuts.calendarInputs[num].value = dateFormat(d, 'dd/mm/yyyy'); //d.getISODate(); -- Marinho Brandao
